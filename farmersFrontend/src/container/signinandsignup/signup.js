...
function Signup() {
  ...
  const { name, email, password, error, success, password2 } = values;
  ...
  const clickSubmit = (event) => {
    ...
    Signupuser({ name, email, password, password2 }).then((data) => {
      if (data?.message) {
  ...
  const showError = () => (
    <div
      className="alert alert-danger signup__alert"
  ...
  const showSuccess = () => (
    <div
      className="alert alert-info signup__alert"
      style={{ display: success ? "" : "none" }}
    >
      <p>New account is created please sign in</p>
    </div>
  );
      ...
      <div>
        <div class="register__body">
          ...
          >
            ...
            <rect x="768.87" y="427.93" width="69" height="34" fill="#0ecf5f" />
            <path
          ...
          <div class="register__signup-box">
            <h1>Signup</h1>
            {showError()}
            {showSuccess()}
            <form>
              <div style={{ marginBottom: "8%" }} class="login__inputs">
                <i
              ...
              <button class="register__btn-customize" onClick={clickSubmit}>
                Register
              </button>
            </form>
          </div>
