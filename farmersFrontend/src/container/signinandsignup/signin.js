...
import { authenticate, Signinuser } from "../auth/index";
...
function Signin() {
  ...
  const showError = () => (
    <div
      className="alert alert-danger signin__alert "
      style={{ display: error ? "" : "none", fontSize: "" }}
    >
      <p>{error}</p>
    </div>
  );
        ...
        <div class="login__body">
          <div class="container login__container">
            ...
            <div class="login__login-box">
              ...
              <form>
                <div style={{ marginBottom: "10%" }} class="login__inputs">
                  <i
                ...
                <div class="login__inputs" style={{ marginBottom: "15%" }}>
                  <i
                ...
                <div class="login__btn--flex">
                  <button
                    class="btn login__btn--customize"
                    onClick={clickSubmit}
                  >
                    Sign in
                  </button>
